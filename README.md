...
1b | Link to `commit #1 from Github.com` | [commit #1 from Github.com](https://github.com/omundy/learn-git-milestones/compare/main...tyleryandt18:learn-git-milestones:main)
1c | Link to markdown tables docs | [Link to markdown tables doc](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/organizing-information-with-tables)
...
3a | Link to `first-website` github.com repo page | [first-website repo page](https://github.com/tyleryandt18/first-website)
4a | Link to `first-website` github.io "project site" | [first website project site](https://tyleryandt18.github.io/first-website/)
